...
/**
 * A minimal in-place iterative radix-2 Cooley–Tukey FFT — just enough for the [Chromagram]
 * front-end, with no external dependency. Operates on parallel real/imaginary arrays whose length
