...
- **English and German** — pick the language in the app, without changing the whole phone. German note names (H/B) are a separate switch, since being taught H is not the same thing as reading German.
